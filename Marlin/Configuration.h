...
//#define USE_YMIN_PLUG  //@@SapphirePro
...
#define USE_YMAX_PLUG  //@@SapphirePro
...
#define Y_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop.  //@@SapphirePro
...
#define X_MAX_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop.  //@@SapphirePro
#define Y_MAX_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop.  //@@SapphirePro
#define Z_MAX_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop.  //@@SapphirePro
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING DISABLED(SPRO_BLTOUCH) // Set to true to invert the logic of the probe. @@ Because for BLTOUCH (should be true otherwise?) //=DISABLED(BLTOUCH)==false
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -38, -1.48 }  //@@BLTouch offset using mount by @AlloT: https://www.thingiverse.com/thing:3977061 ;
...
#define XY_PROBE_FEEDRATE (133*60)  //@@? BLTouch - default (133*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (4*60)  //=HOMING_FEEDRATE_Z
