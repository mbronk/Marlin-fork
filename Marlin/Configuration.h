...
//#define THERMAL_PROTECTION_CHAMBER // Enable thermal protection for the heated chamber //@@SapphirePro
...
#define PREHEAT_1_TEMP_HOTEND 200  //@@SapphirePro
#define PREHEAT_1_TEMP_BED     65  //@@SapphirePro
...
#define FSMC_GRAPHICAL_TFT //@@SapphirePro - Classic Marlin menu-driven UI
  ...
  //
  #define FSMC_UPSCALE 3 //backported - do cherry pick properly. Note The original marlin screen does display on errors! //@@SapphirePro
...
//#define TFT_COLOR_UI
//#define TFT_LVGL_UI
// #define TFT_LITTLE_VGL_UI //@@SapphirePro - OLD !! MKS graphical touch UI (simmilar to the one shipping with the printer, incl. print preview etc). Some options like ADVANCED_PAUSE are N/A
// #define TFT_LVGL_UI //@@SapphirePro !! MKS graphical touch UI (simmilar to the one shipping with the printer, incl. print preview etc). Some options like ADVANCED_PAUSE are N/A
  ...
  #undef LCD_BED_LEVELING //@@SapphirePro - not working with TFT_LITTLE_VGL_UI
    ...
    #define FILAMENT_RUNOUT_SCRIPT "" //@@SapphirePro - reconsider!!
  #endif
#endif
...
//WAS: if DISABLED(TFT_LITTLE_VGL_UI) && DISABLED(FSMC_GRAPHICAL_TFT)  //@@SapphirePRO - OLD
  ...
  #error "Both MKS graphical UI and classic Marlin UI are disabled - pick one" //@@SapphirePRO
#elif ENABLED(TFT_LVGL_UI) && ENABLED(TFT_COLOR_UI) //@@SapphirePRO
  #error "Both MKS graphical UI and classic Marlin UI are enabled - pick one" //@@SapphirePRO
#endif //@@SapphirePRO
//=============================================================================
//============================  Other Controllers  ============================
//=============================================================================
